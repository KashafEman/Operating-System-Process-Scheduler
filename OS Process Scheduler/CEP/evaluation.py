...
from algos import  read_processes_from_dataframe, fcfs_scheduling, evaluate_performance
...
def tab_animation(tab_name, gif_Label, scheduled_processes,tab):
        ...
        if is_playing:
            ...
            if count == len(frames)-70:
                ...
                for tab, tab_name,label, gif_path, scheduled_process in zip(tabs, tab_names,tab_gif_label, gif_paths, scheduled_processes):
                    ...
                    tab_animation(tab_name, label, scheduled_process,tab)
