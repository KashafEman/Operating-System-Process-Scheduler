...
from algos import  read_processes_from_dataframe, priority_scheduling_preemptive,  evaluate_performance
...
insert_performance_data("PPS", avg_turnaround_time, avg_waiting_time)
