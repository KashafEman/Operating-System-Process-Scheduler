...
from algos import Process, read_processes_from_dataframe, multilevel_queue_scheduling, evaluate_performance
        ...
        def animate():
            ...
            if tab_isplaying and tab_count < len(frames):
                ...
                if tab_count == len(frames)-110:
                    ...
                    canvas = tk.Canvas(tab, width=680, height=400, bg='#ff007e')
                    ...
                    def next():
                        app.destroy()
                        subprocess.run([sys.executable, 'CEP\Eval.py'])
                    ...
                    def back():
                        app.destroy()
                        subprocess.run([sys.executable, 'CEP\sjf.py'])
...
tabs = []
tab_names = ["Multi level Queue"]  # Add more tab names here
gif_paths = [
                    "CEP\MQS.gif"
