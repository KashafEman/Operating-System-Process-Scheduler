...
from algos import Process, read_processes_from_dataframe, sjf_scheduling, evaluate_performance
...
scheduled_processes1 = sjf_scheduling(processes)

avg_turnaround_time, avg_waiting_time = evaluate_performance(scheduled_processes1)
insert_performance_data("SJF", avg_turnaround_time, avg_waiting_time)
...
tabs = []
tab_names = ["SJF"]  # Add more tab names here
gif_paths = [
                    "CEP\sj.gif"
